...
<?php include_once('src/vista/parcial/mensaje_modal.php'); ?>
<?php include_once('src/vista/usuario/crear.php'); ?>
<?php include_once('src/vista/usuario/editar.php'); ?>
<?php include_once('src/vista/usuario/eliminar.php'); ?>
